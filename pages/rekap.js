...
const pctChange = (cur, prev) => {
  ...
  if (!p && c) return { pct: 100, label: '+∞', dir: 'up' }
...
export default function RekapBulanan() {
  ...
  // ✅ TOTAL MASUK = (LABA AUTO) + (MASUK MANUAL)
  ...
  // ===== Insight cepat: hari ini & bulan ini =====
  ...
  function setIncomePreset(mode) {
    ...
    if (mode === 'mingguan') {
      setIncomeStart(now.subtract(11, 'week').startOf('isoWeek').format('YYYY-MM-DD'))
      setIncomeEnd(now.endOf('isoWeek').format('YYYY-MM-DD'))
    }
    if (mode === 'bulanan') {
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6">
        ...
        {mainTab === 'dashboard' && (
          <>
            ...
            <div className={`${card} p-4 md:p-5 mb-6`}>
              <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between mb-3">
                <div>
                  ...
                  <div className="text-sm text-gray-600">Pilih cepat atau tentukan tanggal manual, lalu lihat detail table.</div>
                </div>
              </div>
            ...
            {/* ===== Insight Detail (periode) ===== */}
            <div className={`${card} p-4 md:p-5 mb-6`}>
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-4">
                <div>
                  <div className="text-lg font-bold text-gray-900">Insight Detail (Periode)</div>
                  <div className="text-sm text-gray-600">Average ticket, margin %, top produk, performa karyawan (invoice-based).</div>
                </div>
                      ...
                      <div className="grid gap-3 md:grid-cols-3 mb-4">
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-3">
                          ...
                          <div className="mt-2 text-xs text-gray-600">
                            Laba Bulanan (Auto): <b>{formatRp(financeAgg.autoMasuk)}</b>
                            <br />
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-3">
                          ...
                          <div className="mt-2 text-xs text-gray-600">Rumus: (Laba Auto + Masuk Manual) - Keluar Manual</div>
                        </div>
                      </div>
