    ...
    <div style={{ padding: 20, fontFamily: "'Inter', sans-serif", background: "#f5f5f5", minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{
          ...
          <img src="/logo-connect-transparan.png" alt="Logo" style={{ width: 32, margin: "auto", display: "block", paddingTop: 16 }} />
          <h2 style={{ textAlign: "center", margin: 0, fontSize: 16, color: "#000" }}>INVOICE</h2>
        </div>
